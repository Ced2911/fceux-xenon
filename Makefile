...
GUI_SRC         := gui/source gui/source/libwiigui gui/source/images gui/source/fonts gui/source/sounds \
                    gui/source/lang gui/source/vec gui/source/fceux

GUI_INC         := gui/source gui/source/fceux	
	
SOURCES		:= $(GUI_SRC) src src/drivers/xenon src/utils/ src/mappers src/input src src/boards
INCLUDES	:= $(GUI_INC) src
